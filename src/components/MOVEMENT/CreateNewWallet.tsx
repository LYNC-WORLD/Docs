...
export const CreateNewWallet = () => {
  ...
  const [network, setNetwork] = useState<any>(3);
  ...
  }, [email, dashboardApiKey, xApiKey, network]);
      ...
      <div className="w-full lg:grid lg:grid-cols-2 ">
        <div>
          <div className="lg:pr-5 w-full">
            ...
            <div className=" ">
              {BODY.fields.slice(0, 1).map((field, index) => (
                <div
                  key={index}
              ...
              {BODY.fields.slice(-2, -1).map((field, index) => (
                <div
                  key={index}
              ...
              {BODY.fields.slice(-1).map((field, index) => (
                <div
                  key={index}
