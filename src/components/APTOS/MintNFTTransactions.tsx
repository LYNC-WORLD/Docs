  ...
  fields: [
    {
      ...
      example:
        "0x4bb424eb03c0105e44e42a07294a7c9ed78b75942549b02844892401b578d150",
      required: true,
    },
    {
      name: "contractName",
    ...
    },
    {
      ...
      example:
        "0x9e568d375d7dc88dcb58577a4167b11e559b3fed222f91383518e58f8565f353",
      required: true,
    },
    {
      name: "publicAddress",
      ...
      example:
        "0x41e019155a0916372341bcdb684b6e571b68563f933c3139deae6a9fac3fc38b",
      required: true,
    },
    {
      name: "arguments",
...
const GET_SAMPLE_CODE = (sampleCodeParams: SampleCodeParams) => {
  ...
  const getArgumentsField = () => {
    ...
    return argumentsArray
      .map((argument, index) => {
        return `                    { argument: ${getTextInSingleQuotes(
          argument.argument
        )}, type: ${argument.type} }`;
      })
      .join(",\n");
...
export const MintNFTTransactions = () => {
  ...
  const [contractAddress, setContractAddress] = useState<string>(
    BODY.fields[0].example + ""
  );
  const [contractName, setContractName] = useState<string>(
    BODY.fields[1].example + ""
  );
  const [functionName, setFunctionName] = useState<string>(
    BODY.fields[2].example + ""
  );
  const [privateAddress, setPrivateAddress] = useState<string>(
    BODY.fields[3].example + ""
  );
  ...
  const [usingPaymaster, setUsingPaymaster] = useState<boolean>(
    BODY.fields[7].example === "true"
  );
      ...
      <div className="w-full lg:grid lg:grid-cols-2 ">
        <div>
          <div className="lg:pr-5 w-full">
            ...
            <div className=" ">
              {[BODY.fields[0]].map((field, index) => (
                <div
                  key={index}
                  className="border-b-0 rounded-t-[var(--ifm-global-radius)] border-[length:var(--ifm-global-border-width)]  border-[var(--ifm-toc-border-color)] border-solid ">
              ...
              {[BODY.fields[1]].map((field, index) => (
                <div
                  key={index}
                  className="border-b-0  border-[length:var(--ifm-global-border-width)]  border-[var(--ifm-toc-border-color)] border-solid ">
                ...
                <div
                  ...
                  <div className="px-5 pb-4">
                    {!argumentsArray.length && (
                      <div className="rounded-t-[var(--ifm-global-radius)] p-2 border-b-0 border-solid border-[length:var(--ifm-global-border-width)]  border-[var(--ifm-toc-border-color)]">
                        No Items in array
                      </div>
                    )}
                      ...
                      argumentsArray.map((argument, index) => {
                        ...
                        return (
                          <div
                            key={index}
                            className={cn(
                              "px-[0.75rem] py-[0.75rem] border-solid border-[length:var(--ifm-global-border-width)] border-b-0  border-[var(--ifm-toc-border-color)]",
                              index === 0 &&
                            ...
                            <div>
                              <div className="px-[1rem] space-x-3  py-[0.25rem] text-[13px] rounded-t-[var(--ifm-global-radius)] border-b-0 border-solid border-[length:var(--ifm-global-border-width)]  border-[var(--ifm-toc-border-color)]">
                                <button
                                  onClick={handleRemoveOfItem}
                                  className="bg-transparent hover:border-solid hover:border-[length:var(--ifm-global-border-width)]  hover:border-[var(--ifm-toc-border-color)] outline-none border-none font-semibold cursor-pointer">
                                  Remove
                                </button>
                              ...
                              <div className="px-[1rem] py-[0.75rem] space-y-3 rounded-b-[var(--ifm-global-radius)] border-solid border-[length:var(--ifm-global-border-width)]  border-[var(--ifm-toc-border-color)]">
                                {field.field.fields.map((argField) => {
                                  ...
                                  const argFieldItem = argumentsArray.find(
                                    (argField) => {
                                      return argField.id === id;
                                    }
                                  );
                                  const argFieldValue =
                                    argFieldItem[argField.name];

                                  const handleArgFieldValueChange = (e) => {
                                    const newArgFieldItem = argFieldItem;
                                    newArgFieldItem[argField.name] =
                                      e.target.value;

                                    const newArgumentsArray = argumentsArray
                                      .slice(0, index)
                                      .concat(newArgFieldItem)
                                      .concat(argumentsArray.slice(index + 1));
                                    setArgumentsArray(newArgumentsArray);
                                  };
                                  return (
                                    <div
                                      key={argField.name}
                                      className="flex items-center flex-col gap-2 justify-between">
                                      <div className="w-full flex flex-col justify-center">
                                        <div className="flex items-center gap-2">
                                          <span className=" font-[--ifm-font-weight-semibold]   ">
                                            {argField.name}{" "}
              ...
              {[BODY.fields[7]].map((field, index) => (
                <div
                  ...
                  <div className=" flex items-center flex-col gap-2 justify-between px-5 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <select
                      onChange={(e) =>
                        setUsingPaymaster(e.target.value === "true")
                      }
                      value={usingPaymaster ? "true" : "false"}
                      name=""
                      id=""
                      className=" w-full py-[0.6rem] px-[0.8rem] outline-none rounded-[var(--ifm-global-radius)] resize-none  border-[length:var(--ifm-global-border-width)] border-[var(--ifm-toc-border-color)] border-solid">
              ...
              {[BODY.fields[8]].map((field, index) => (
                <div
                  key={index}
                  className="rounded-b-[var(--ifm-global-radius)]  border-[length:var(--ifm-global-border-width)]  border-[var(--ifm-toc-border-color)] border-solid ">
                  <div className=" flex items-center flex-col gap-2  justify-between px-5 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    <div className="w-full flex flex-col justify-center">
                      <div className="flex items-center gap-2">
                        <span className=" font-[--ifm-font-weight-semibold]   ">
            ...
            <div className="flex items-start justify-between">
              <div className="space-y-1 ">
                <div className="gap-3 flex items-center">
                  <span className="md:text-2xl font-bold mb-0.5 w-40 md:w-52">
                    {"x-api-key"}
                  </span>
                  ...
                  <button
                    ...
                    className={cn(
                      " flex items-center self-stretch justify-center md:w-1/3  bg-[var(--ifm-color-primary)] border-none py-[0.4rem] px-[0.8rem] rounded-md md:text-lg cursor-pointer",
                ...
                <h6 className="w-[80%] font-extralight">
                  <ReactMarkdown>
                    {
                      "API key to be put into the header as x-api-key for the validation of HTTP requests on our server"
                    }
                  </ReactMarkdown>
                </h6>
              </div>
