...
function ProductThreePerLine({ text, url }: { text: string; url?: string }) {
  return (
    <Link
      to={url}
      className="hover:no-underline cursor-pointer transition-all duration-200 box-border w-full self-stretch lg:w-full rounded-lg backdrop-blur-[27px] flex items-center justify-center bg-[rgba(0,0,0,0.5)] hover:bg-[rgba(0,0,0,0.4)] p-4   border-[1px] border-solid border-[rgba(255,255,255,0.25)] hover:border-[rgba(255,255,255,0.8)] font-normal text-sm lg:text-base lg:leading-[20px] text-white text-center  ">
      {text}
    </Link>
  );
}
        ...
        <div className="w-full flex flex-col items-center relative px-4 lg:px-0 pt-20 pb-10 lg:py-36 gap-10">
          ...
          <div className="flex items-center flex-col ">
            <p className="text-white font-grotesk font-semibold text-3xl lg:text-5xl leading-[40px] lg:leading-[52px] text-center">
              Mew.gg Documentation
            </p>
            <p className="text-[#FFFFFFCC] hidden lg:block font-grotesk font-light text-xl  leading-8 text-center">
              Mew.gg is a meme coin launchpad and marketplace for fair buying,
              <br></br> selling, and trade of meme coins. Assets Mew Network is
              <br></br>100% safe and secure with no pre-mint sale or team
              <br></br>allocation to prevent rug pulls.
            </p>
