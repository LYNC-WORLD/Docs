...
Market capitalization, or "market cap," represents the total dollar($) market value of a token while it's being traded on [Kensei](https://kensei.one/).

<div className="flex flex-col items-center">
    <img src="/img/kensei/market-cap.png"/>
...
> NOTE -
>
> Kensei only shows the market cap of a particular token until the token is bonded.

## Market cap calculation on Kensei
