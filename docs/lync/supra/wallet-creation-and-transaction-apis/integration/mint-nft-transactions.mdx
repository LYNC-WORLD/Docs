...
```bash
POST https://server-supra-sdk.lync.world/api/v1/nft/mint-nft
```
...
import { MintNFTTransactions } from "@site/src/components/SUPRA/MintNFTTransactions";
import BrowserOnly from "@docusaurus/BrowserOnly";

<BrowserOnly>{() => <MintNFTTransactions />}</BrowserOnly>
