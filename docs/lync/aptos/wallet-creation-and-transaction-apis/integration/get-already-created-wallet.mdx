...
```bash
POST https://server-aptos-sdk.lync.world/api/generate_wallet/get_wallet
```
...
import { GetAlreadyCreatedWallet } from "@site/src/components/APTOS/GetAlreadyCreatedWallet";
import BrowserOnly from "@docusaurus/BrowserOnly";

<BrowserOnly>{() => <GetAlreadyCreatedWallet />}</BrowserOnly>
