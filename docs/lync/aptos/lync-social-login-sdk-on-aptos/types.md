...
id: types-used-in-the-methods-provided-by-the-sdk
...
type AptosTransactionArguments = {
  argument: string;
  type: "string" | "number" | "byte_array" | "signature";
};
...
type AptosTransactionReturn =
  | { success: true; data: AptosTransactionData }
